//Global Declarations
var btnAddStock = document.getElementById("btnAddStock");
var btnItemsShipped = document.getElementById("btnItemsShipped");
var buyerEmailAddressArray = [];
btnAddStock.addEventListener("click", function () {
    //Accept the inputs from the textboxes
    var itemsReceived = document.querySelector("#itemsReceived").value;
    var itemsPrice = document.querySelector("#itemsPrice").value;
    var newItemQuantity = 0;
    var newProductPrice = 0;
    var firstProductList = document.getElementById("firstProductList");
    var table = document.getElementById("tableStockLevels");
    //let table: HTMLTableElement = document.querySelector('#tableStockLevels');
    var optionIndex = firstProductList.selectedIndex;
        ...
        if (isNaN(parseFloat(itemsPrice))) {
            ...
            switch (optionIndex) {
                case 1:
                    ...
                    var productOneItemQuantity = parseInt(table.rows[0].cells[1].innerHTML);
                    ...
                    var productOnePrice = parseFloat(table.rows[1].cells[0].innerHTML);
                ...
                case 2:
                    ...
                    the new item quantity that the user typed in and display it in the Stock Levels Section*/
                    var productTwoItemQuantity = parseInt(table.rows[2].cells[1].innerHTML);
                   ...
                   and display the average price for product two in the Average Stock Price Section*/
                    var productTwoPrice = parseFloat(table.rows[3].cells[0].innerHTML);
                ...
                case 3:
                    ...
                    the new item quantity that the user typed in and display it in the Stock Levels Section*/
                    var productThreeItemQuantity = parseInt(table.rows[4].cells[1].innerHTML);
                  ...
                  and display the average price for product three in the Average Stock Price Section*/
                    var productThreePrice = parseFloat(table.rows[5].cells[0].innerHTML);
...
btnItemsShipped.addEventListener("click", function () {
    ...
    var buyerEmailAddress = document.querySelector("#buyerEmailAddress").value;
    var itemsBought = document.querySelector("#itemsBought").value;
    var newItemQuantity = 0;
    var secondProductList = document.getElementById("secondProductList");
    var table = document.getElementById("tableStockLevels");
    var optionIndex = secondProductList.selectedIndex;
